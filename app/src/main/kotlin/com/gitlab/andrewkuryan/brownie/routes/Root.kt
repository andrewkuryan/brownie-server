...
fun Application.rootRoutes(storageApi: StorageApi, srpGenerator: SrpGenerator, emailService: EmailService, gson: Gson) {
    routing {
        userRoutes(storageApi, srpGenerator, emailService, gson)
    }
}